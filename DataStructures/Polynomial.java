...
public class Polynomial {
	...
	public Polynomial add(Polynomial p) {
		...
		Node sum = null, ptr1 = poly, ptr2 = p.poly;
		while (ptr1 != null && ptr2 != null) {// pointers alternate
			if (ptr1.term.degree == ptr2.term.degree) {
				if (ptr1.term.coeff + ptr2.term.coeff != 0) sum = new Node(
						ptr1.term.coeff + ptr2.term.coeff, ptr1.term.degree,
						sum);
				ptr1 = ptr1.next;
				ptr2 = ptr2.next;
		...
		for (; ptr2 != null; ptr2 = ptr2.next)
			sum = new Node(ptr2.term.coeff, ptr2.term.degree, sum);
		for (; sum != null; sum = sum.next)
			temp.poly = new Node(sum.term.coeff, sum.term.degree, temp.poly);
		return temp;
	}
	...
	public Polynomial multiply(Polynomial p) {
		/** COMPLETE THIS METHOD **/
		Polynomial temp = new Polynomial(), temp2 = new Polynomial();
		Node ptr1 = poly, ptr2 = p.poly;
		for (; ptr1 != null; ptr1 = ptr1.next, ptr2 = p.poly)
			for (; ptr2 != null; ptr2 = ptr2.next, temp2 = new Polynomial())
				if (ptr1.term.coeff * ptr2.term.coeff != 0) {
					temp2.poly = new Node(ptr1.term.coeff * ptr2.term.coeff,
