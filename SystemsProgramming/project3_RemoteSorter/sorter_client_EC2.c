...
void *transfer(void *rawpath)
{
    ...
    filelength[0] = (char)session;
    sprintf(filelength + 1, "%d", stat_buf.st_size);
...
void sendcolinfo()
{
    ...
    recv(sockfd, protocol, sizeof(protocol), 0);
